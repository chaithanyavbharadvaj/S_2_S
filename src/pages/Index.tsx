...
import { Video, VideoOff, Volume2, Trash2, BookOpen } from 'lucide-react';
          ...
          <Sheet>
            <SheetTrigger asChild>
              <Button
                size="lg"
                variant="outline"
                className="transition-all duration-300 border-primary/50 hover:border-primary hover:bg-primary/10"
              >
